<main class="dashboard-page" style="align-items:flex-start;">
    ...
    <section class="dashboard-content" style="padding:50px 70px;">
        ...
        <form action="<?= base_url('actualizar_profesor/'.$cliente['id_persona']) ?>" method="post"
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:22px 30px;">
                ...
                <?php else: ?>
                    <?php
                        $rolActual = (int) ($cliente['id_rol'] ?? 2);
            ...
            <div style="margin-top:30px;">
                <div style="display:flex; gap:30px; flex-wrap:wrap; align-items:center;">
                    ...
                    <a href="<?= base_url('profesores') ?>" class="btn-main" style="background:#555;">Cancelar</a>
                </div>
