                ...
                <tbody>
                    <?php if(!empty($horarios)): ?>
                        <?php foreach($horarios as $horario): ?>
                            <tr>
                                <td><?= esc($horario['nombre_sistema']) ?></td>
                                <td><?= esc($horario['dia_semana']) ?></td>
                                <td><?= formatear_hora($horario['hora_inicio']) ?></td>
                                <td><?= formatear_hora($horario['hora_fin']) ?></td>
                                <td>
                                    <?php if($horario['baja'] == 'S'): ?>
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    <?php if($horario['baja'] == 'N'): ?>
                                        <a href="<?= base_url('baja_horario/'.$horario['id_horario']) ?>"
                                           class="btn btn-danger btn-sm"
                                           onclick="return confirm('¿Desea dar de baja este horario?');">
                                            Dar de baja
                                        </a>
                                    <?php else: ?>
                                        <a href="<?= base_url('alta_horario/'.$horario['id_horario']) ?>"
...
<script>
    ...
    if (buscarHorario && tablaHorarios) {
        buscarHorario.addEventListener('keyup', function () {
            ...
            const filas = tablaHorarios.querySelectorAll('tbody tr');
